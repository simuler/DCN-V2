...
class FEFM(nn.Layer):
    ...
    def forward(self, sparse_inputs, dense_inputs):
        ...
        # print('sparse',len(sparse_inputs))
        ...
        # print('feat_embed', feat_embeddings.shape.shape)
        # exit(0)
